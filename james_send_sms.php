...
function send_user_sms()
{
    ...
    foreach ($pins as $pin) {
        $sms_user_msg_tpl = "We have received your payment and your session on $slotStartDate has been confirmed. For assistance, you can contact our staff, BK at 93835592. Your Pins is $pin";
